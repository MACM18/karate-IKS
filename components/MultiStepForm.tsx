      ...
      <form onSubmit={handleSubmit}>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                  {[
                    ...
                    <button
                      ...
                      className={`p-6 border rounded-sm flex flex-col items-center gap-4 transition-all duration-300 ${
              ...
              <div className='grid grid-cols-1 gap-4'>
                {schedules.map((prog) => (
                  <button
                    ...
                    className={`p-6 border rounded-sm flex flex-col md:flex-row md:items-center justify-between gap-4 text-left transition-all duration-300 ${
                  ...
                  >
                    <div>
                      <h3
                        className={`font-heading uppercase text-xl font-bold ${
                          formData.classId === prog.id
                            ? "text-primary"
                            : "text-foreground"
                        }`}
        ...
        <div className='flex justify-between mt-16 pt-8 border-t border-border'>
          <button
            ...
            onClick={handlePrev}
            disabled={step === 1}
            className={`flex items-center gap-2 px-6 py-4 text-[10px] font-black uppercase tracking-[0.2em] transition-all ${
              step === 1
