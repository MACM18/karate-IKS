          ...
          >
            ...
            <div className='space-y-6 text-zinc-400 leading-relaxed text-lg'>
              <p>
                ...
                grandmasters of Okinawa.
              </p>
              <p>
                We represent the Shito-Ryu Shinbukan Karate-Do Association,
                dedicated to preserving the traditional forms (Kata) and
                practical applications (Bunkai) that have been passed down
                through generations.
              </p>
            </div>
          ...
          >
            <div className='aspect-[4/5] relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white/10 dark:border-black/10'>
              ...
              <div className='absolute bottom-8 left-8 z-20'>
                <p className='text-white font-heading font-bold uppercase tracking-widest text-sm mb-1 opacity-80 italic'>
                  The Path of the Master
                </p>
                <h3 className='text-white text-3xl font-heading font-black uppercase'>
