                ...
                <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 h-full md:min-h-[600px]">
                    {programs.map((program, index) => (
                        <motion.div
                            ...
                            className={`group relative overflow-hidden rounded-xl border border-border flex flex-col p-8 transition-all duration-500 hover:shadow-2xl hover:border-primary/50 cursor-pointer ${program.size} ${program.color}`}
                        >
