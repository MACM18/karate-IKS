      ...
      <div className='container mx-auto px-4 lg:px-8'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8'>
          ...
          <div className='space-y-6'>
            ...
            <p className='text-sm leading-relaxed max-w-xs'>
              Dedicated to the preservation and promotion of Shito-Ryu Shinbukan
              Karate-Do. Forging character, discipline, and excellence since
              1988.
            </p>
            ...
            <ul className='space-y-4 text-sm font-medium'>
              ...
              <li>
                <Link
                  ...
                  className='hover:text-primary transition-colors italic opacity-70'
                >
                  Instructor Portal
                </Link>
              </li>
        ...
        <div className='mt-20 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-6'>
          <p className='text-[10px] font-bold uppercase tracking-[0.2em]'>
            © {new Date().getFullYear()} Karate Do Shito-Ryu Shinbukan
            Association.
          </p>
