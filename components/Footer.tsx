...
export function Footer() {
    return (
        <footer className="bg-zinc-100 dark:bg-zinc-900 border-t border-border py-16 text-foreground-muted font-sans">
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left space-y-8 md:space-y-0">
                    <div className="flex-1">
                        <h3 className="text-2xl font-heading font-black uppercase tracking-tighter text-foreground">Karate IKS</h3>
                ...
                <div className="mt-16 pt-8 border-t border-border text-center text-xs uppercase tracking-widest text-zinc-500">
