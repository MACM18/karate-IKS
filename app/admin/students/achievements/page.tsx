            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {achievements.map((achievement) => (
                        <div key={achievement.id} className="bg-zinc-900 border border-zinc-800 p-6 flex flex-col justify-between group hover:border-primary/50 transition-colors">
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-zinc-500 italic line-clamp-3 leading-relaxed">{achievement.description || "Official Dojo Recognition"}</p>
                                </div>
                            </div>
                        </div>
                    ))}
