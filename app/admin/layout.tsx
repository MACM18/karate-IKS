            ...
            <aside className="w-64 border-r border-zinc-900 bg-zinc-950 hidden md:flex flex-col fixed h-full z-30">
                ...
                <nav className="flex-1 p-4 space-y-1 overflow-y-auto pt-6">
                    ...
                    >
                        ...
                        <span className="uppercase text-[10px] font-black tracking-widest">Student Roster</span>
                    </Link>
                    <Link
                    ...
                    >
                        ...
                        <span className="uppercase text-[10px] font-black tracking-widest">Attendance</span>
                    </Link>
                    <Link
                    ...
                    >
                        ...
                        <span className="uppercase text-[10px] font-black tracking-widest">Promotions</span>
                    </Link>
                    <Link
                        href="/admin/exams"
                        className="flex items-center gap-4 px-4 py-3 text-zinc-500 hover:text-white hover:bg-zinc-900 rounded-lg transition-all group"
                    >
                        ...
                        <span className="uppercase text-[10px] font-black tracking-widest">Exam Forge</span>
                    </Link>
                    <Link
                    ...
                    <div className="pt-8 pb-4">
                        ...
                        <Link
                            ...
                            className="flex items-center gap-4 px-4 py-3 text-zinc-500 hover:text-white hover:bg-zinc-900 rounded-lg transition-all group"
                        >
                            <PenTool size={20} className="group-hover:text-primary transition-colors" />
                            <span className="uppercase text-[10px] font-black tracking-widest">News CMS</span>
                        </Link>
                        <Link
                ...
                <div className="p-6 border-t border-zinc-900 space-y-2">
                    <Link href="/api/auth/signout" className="flex items-center gap-4 px-4 py-3 text-zinc-600 hover:text-primary transition-colors group">
                        <LogOut size={18} />
                        <span className="uppercase text-[10px] font-black tracking-widest">Sign Out</span>
                    </Link>
                </div>
            </aside>
