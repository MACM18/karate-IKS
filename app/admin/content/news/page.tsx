    ...
    return (
        <div className="p-8 space-y-12 max-w-7xl mx-auto min-h-screen relative">
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <h1 className="text-5xl font-heading font-black uppercase tracking-tighter text-white">News <span className="text-primary italic">Management</span></h1>
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                    {posts.map((post) => (
                        <div key={post.id} className="bg-zinc-900 border border-zinc-800 p-6 flex flex-col md:flex-row items-start justify-between gap-6 group hover:border-zinc-700 transition-colors">
                            <div className="flex flex-col md:flex-row gap-6">
                                ...
                                <div className="space-y-2 flex-1">
                                    ...
                                    <h3 className="text-2xl font-heading font-black text-white group-hover:text-primary transition-colors">{post.title}</h3>
                                    <p className="text-sm text-zinc-500 line-clamp-3 leading-relaxed max-w-3xl">{post.content}</p>
                    ...
                    {posts.length === 0 && (
                        <div className="py-24 text-center border border-dashed border-zinc-800 text-zinc-600">
                            ...
                            <p className="italic font-medium">No intelligence reports forged yet.</p>
                        </div>
                    )}
                </div>
            </div>
