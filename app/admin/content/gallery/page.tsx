...
import { Plus, Trash2, Star, Image as ImageIcon, Grid, Tag } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <h2 className="text-sm font-black uppercase tracking-[0.3em] text-zinc-500 flex items-center gap-2">
                        <Plus size={16} /> Archive New Intel
                    </h2>
                    <GalleryUploadForm />
                </div>
                ...
                <div className="lg:col-span-3 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        ...
                        {items.length === 0 && (
                            <div className="col-span-full py-24 text-center border border-dashed border-zinc-800">
                                <ImageIcon size={48} className="mx-auto text-zinc-800 mb-4" />
                                <p className="text-zinc-500 font-medium italic">Archive is empty. Ready for strategic intel.</p>
                            </div>
                        )}
                    </div>
                </div>
