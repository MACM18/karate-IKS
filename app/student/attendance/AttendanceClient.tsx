    ...
    <div className='min-h-screen bg-black text-white p-4 md:p-10 max-w-7xl mx-auto w-full'>
      <header className='mb-16'>
        ...
        <p className='text-zinc-500 mt-4 font-medium max-w-2xl'>
          Every session is a battle won against mediocrity. Review your
          historical training data and maintain your combat readiness.
        </p>
      </header>
        ...
        <div className='space-y-8'>
          <div className='bg-zinc-900 border border-zinc-800 p-8 hover:border-primary transition-all group'>
            ...
            <div className='text-5xl font-heading font-black text-white'>
              {stats.streak}{" "}
              <span className='text-sm font-black text-zinc-700 uppercase tracking-tighter'>
                Day Streak
              </span>
            </div>
          </div>
          ...
          <div className='bg-zinc-900 border border-zinc-800 p-8 hover:border-primary transition-all group'>
            ...
            <p className='text-[10px] text-zinc-600 font-bold uppercase tracking-widest mt-4'>
              Across {stats.totalClasses} Sessions
            </p>
          </div>
          ...
          <div className='bg-zinc-900 border border-zinc-800 p-8 hover:border-primary transition-all group'>
            ...
            {stats.lastClass ? (
              ...
              <div className='text-xl font-heading font-black text-zinc-700 italic'>
                No Data Recorded
              </div>
            )}
          </div>
              ...
              attendance.map((log) => (
                ...
                >
                  <div className='flex items-center gap-6'>
                    <div className='w-12 h-12 bg-black border border-zinc-800 flex items-center justify-center text-primary'>
