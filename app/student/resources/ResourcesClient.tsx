    ...
    <div className='min-h-screen bg-black text-white p-4 md:p-10 max-w-7xl mx-auto w-full'>
      <header className='mb-16'>
        ...
        <p className='text-zinc-500 mt-4 font-medium max-w-2xl'>
          Master the sacred techniques. Access Heian katas, Kihon manuals, and
          restricted combat intelligence based on your rank.
        </p>
      </header>
      ...
      <div className='flex flex-col md:flex-row md:items-center justify-between gap-8 mb-12'>
        ...
        <div className='relative w-full md:w-80'>
          ...
          <input
            ...
            className='w-full bg-zinc-900 border border-zinc-800 py-3 pl-12 pr-4 text-[10px] font-black uppercase tracking-widest text-white focus:outline-none focus:border-primary placeholder:text-zinc-700 transition-all'
          />
        </div>
      </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 pb-32'>
        {filteredResources.length === 0 ? (
          <div className='col-span-full py-32 text-center border border-dashed border-zinc-800'>
            <Layers
              size={48}
              className='mx-auto text-zinc-800 mb-6 opacity-20'
            />
            <p className='text-zinc-700 font-bold uppercase tracking-widest italic'>
              No matching intelligence found in archives.
            </p>
          </div>
        ) : (
