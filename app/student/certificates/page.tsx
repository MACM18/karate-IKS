    ...
    <div className='min-h-screen bg-black text-white p-4 md:p-10 max-w-7xl mx-auto w-full'>
      <header className='mb-16'>
        ...
        <p className='text-zinc-500 mt-4 font-medium max-w-2xl'>
          Official recognitions and belt certifications issued by the Shito-Ryu
          Shinbukan Headquarters.
        </p>
      </header>
          ...
          <div className='bg-zinc-900 border border-zinc-800 p-8 relative overflow-hidden group'>
            ...
            <div className='relative z-10'>
              ...
              <p className='text-zinc-400 text-sm leading-relaxed mb-8 italic'>
                "The journey of a thousand strikes begins with a single bow."
                You are currently holding the rank of{" "}
                {profile.currentRank?.name || "White Belt"}.
              </p>
              {nextRank && (
                <div className='pt-8 border-t border-zinc-800'>
                  ...
                  <div className='text-xl font-heading font-black text-white uppercase'>
                    {nextRank.name}
                  </div>
                </div>
              )}
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            {profile.promotions.map((promo: any) => (
              <CertificateCard
                ...
                date={new Date(promo.promotedAt).toLocaleDateString(undefined, {
                  month: "long",
                  day: "numeric",
                  year: "numeric",
                })}
            ...
            {profile.promotions.length === 0 && (
              <div className='md:col-span-2 p-12 text-center border border-dashed border-zinc-800'>
                <Shield
                  size={48}
                  className='mx-auto text-zinc-800 mb-4 opacity-20'
                />
                <p className='text-zinc-600 font-medium italic'>
                  No digital certifications have been issued yet. Complete a
                  grading to earn your first award.
                </p>
              </div>
            )}
          </div>
